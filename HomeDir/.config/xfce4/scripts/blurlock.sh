...
convert -resize $(xdpyinfo | grep dimensions | cut -d\  -f7 | cut -dx -f1) $SCREEN -blur 0x4 /home/$USER/.cache/xfcelock/blurlock.png &&\

#Use the blurred picture in the lock screen
i3lock -i /home/$USER/.cache/xfcelock/blurlock.png
